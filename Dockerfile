...
# Start Docker deamon
# docker build -t iam-complex-trf:iam_1.22 .
# Tag it and push to quay
# docker tag iam-complex-trf:iam_1.22 quay.io/msentissi/iam-complex-trf:iam_1.22
# docker push quay.io/msentissi/iam-complex-trf:iam_1.22
