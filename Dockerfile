...
# Start Docker deamon
# docker build -t iam-complex-trf:iam_1.12 .
# Tag it and push to quay
# docker tag iam-complex-trf:iam_1.12 quay.io/msentissi/iam-complex-trf:iam_1.12
# docker push quay.io/msentissi/iam-complex-trf:iam_1.12
